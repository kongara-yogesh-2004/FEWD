...
import { FaShoppingCart, FaFacebook, FaTwitter, FaInstagram, FaCloudSun, FaTemperatureHigh } from "react-icons/fa";
  ...
  return (
    <div className="container mt-4 text-center">
      ...
      <div>
        <h4>New York, US</h4>
        <p>
          <FaCloudSun /> Clear Sky
        </p>
        <p>
          <FaTemperatureHigh /> 22°C
        </p>
      </div>
    </div>
  );
...
// NavigationBar component (same as before)
const NavigationBar = () => {
  return (
...
// ProductCard component (same as before)
...
// ProductList component (same as before)
const ProductList = () => {
  const products = [
    { id: 1, image: "images/img2.jpg", name: "Product 1", price: 29.99 },
    { id: 2, image: "images/img3.jpg", name: "Product 2", price: 39.99 },
    { id: 3, image: "images/img5.jpg", name: "Product 3", price: 49.99 },
  ];
  return (
...
// Categories component (same as before)
const Categories = () => {
...
// FeaturedProducts component (same as before)
const FeaturedProducts = () => {
  const featured = [
    { id: 1, image: "images/img1.jpg", name: "Best Seller 1", price: 59.99 },
    { id: 2, image: "images/img4.jpg", name: "Best Seller 2", price: 69.99 }
  ];
  return (
...
// NewsletterSignup component (same as before)
